...
<section>
    ...
    <div layout="row" layout-align="center center">
        ...
        <div layout="column" flex="66" layout-align="center center">
            <ul>
                <li><span style="color: #5c8dfc">Open Source</span> SDK for the Web</li>
                <li>First released in <span style="color: #5c8dfc">2013</span></li>
                <li>Complete rewrite with <span style="color: #5c8dfc"><strike>Angular</strike></span></li>
                <li>Written in <span style="color: #5c8dfc">Typescript</span></li>
            </ul>
        </div>
    </div>
    <aside class="notes">
...
<section>
    <h2>only <span style="color: #5c8dfc">one language and codebase</span> necessary</h2>
    <aside class="notes">
        <b></b>
    </aside>
</section>
...
<section>
    <h3><span style="color: #5c8dfc">One code base</span> many <span style="color: #5c8dfc">platforms</span></h3>
    <img  src="../../img/html5-css3-js.png" style="margin: 0" width="25%" class="fragment img-plain zoom-in"/>
    <div class="fragment" layout="row" layout-align="center center">
    ...
    <h3>Cordova <span style="color: #5c8dfc">Native app</span> shell</h3>
     <div layout="row" layout-align="center center">
            ...
            <div layout="column" flex layout-align="center center" style="margin-left: 10px">
                <div class="box shell fragment zoom-in" data-fragment-index="1" w100 style="position: relative">
