<section class="stretch">
    ...
    <aside class="notes">
        <b>To support our favorite frameworks, libraries, we keep creating the same code over and over again!</b>
        <b>If we combine all the work of those people, maybe we could have landed a second on the moon, or maybe just the first one :P</b>
        <b>Unfortunetly all we do is creating buttons and toolbar.</b>
    </aside>
</section>
